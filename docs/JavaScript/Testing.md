...
Начните с интеграционных или e2e-тестов. Напишите тесты для наиболее важных частей вашего приложения. Даже если в вашем проекте очень высокая связанность между модулями, то вы все равно сможете без значительных изменений в коде написать высокоуровневые тесты.
